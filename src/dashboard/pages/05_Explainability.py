...
SHAP and LIME feature attributions scheduled for Day 6.
"""
...
st.info("🔍 **Scheduled for Day 6**: SHAP waterfall plots, LIME token weights, and highlighted explanation previews.")
