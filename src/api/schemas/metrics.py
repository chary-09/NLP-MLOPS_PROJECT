...
class MetricsResponse(BaseModel):
    ...
    total_requests: int = Field(..., description="Total prediction requests received since startup", json_schema_extra={"example": 50})
    ...
    uptime_seconds: float = Field(..., description="Uptime in seconds", json_schema_extra={"example": 320.8})
